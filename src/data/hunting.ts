...
export const HUNTING_STEPS: HuntingStep[] = [
  ...
  },
  {
    ...
    shortDesc: "Airport greeting and transfer via private luxury shuttle or helicopter charter directly to the lodge boma.",
    longDesc: "Upon landing in Gqeberha (Port Elizabeth), you are met by an Ivorytip representative who handles your rifle clearance. We transfer you in a luxury air-conditioned vehicle—or a private helicopter charter—directly to the conservancy. Relax with local gin cocktails as Andre and Jenna welcome you at the main ridge deck.",
    image: "/assets/Couples Retreat.jpg",
  ...
  },
  {
    ...
    image: "/assets/lodge_signature_dining.jpg",
  ...
  },
  {
    ...
    image: "/assets/'Fair Hunt' Image.jpg",
  ...
  },
  {
    ...
    shortDesc: "Evening boma dinners, single-malt toasts, and retelling of the stalk's stories.",
    longDesc: "In the evening, the camp comes alive. Trackers, guides, and guests gather around the circular boma fire. We toast the day's stalks with rare single-malts or local brandies. Jenna's kitchen serves gourmet wild game dishes prepared over open coals, while we retell the stories of the hunt under the Southern Cross.",
  ...
  },
  {
    ...
    shortDesc: "Dipping into deep copper baths and sleeping under vaulted thatch as jackals call.",
    longDesc: "Retreat to your private sanctuary for deep rest. Fill the vintage copper bath, slide the glass walls wide, and listen to the savanna night sounds. Sleep in absolute comfort under fine linens, fully refreshed for the morning's new sunrise tracks.",
    image: "/assets/lodge_signature_bedroom.jpg",
  ...
  },
  {
    ...
    image: "/assets/lodge_timber_lounge.jpg",
